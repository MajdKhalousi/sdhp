...
// Same SUPER_ADMIN-excluded nav convention as NAV_REPORTS_SUMMARY_ROLES —
// mirrors backend @Roles(SUPER_ADMIN, ORG_ADMIN, DOCTOR) on GET /reports/appointments.
export const NAV_REPORTS_APPOINTMENTS_ROLES: readonly string[] = ['ORG_ADMIN', 'DOCTOR'];
...
// Page-level access for /dashboard/reports/appointments — mirrors backend
